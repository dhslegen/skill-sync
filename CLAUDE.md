...
## 当前进度(2026-08-29,现役 **v0.5.0**;**v6(一期+二期)+ v7 全部完成、待发 0.6.0**)
...
- **发版前还欠(与 v6 两期的清单合并)**:①本地**未推送**,没有 CI 记录;
...
- **发版前还欠两件**(都不在代码里):①本地**未推送**,所以**没有 CI 记录**——按项目
...
- 本机:Rust **861 = 858 passed + 3 ignored**(54 个 test binary)+ 前端 **718 / 48 files**
