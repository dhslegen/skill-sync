 ...
 * 立刻会出现在下面的列表里:动作与结果在同一屏,用户点完就看得见自己建了什么。
 * ⚠️ **具体落在哪一区,措辞已随 v7 任务 7 更新**:新建的技能库里没有它、本体在
 * 这台电脑上,`ownership::section` 会把它判进「可分享到技能库」区,主按钮是
 * 「分享」——不再是旧文案说的「我分享的 · 尚未分享」(v6 二期两分区页的说法,
 * 那一版已随本任务一起删除)。
 *
 * # 只创建文件,不做别的
 *
