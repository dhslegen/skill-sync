  ...
  return (
    <div className="rounded-card border border-border bg-surface-1">
      <div className="flex items-center gap-2 border-b border-border px-3.5 py-2">
        ...
        <SkillRowMenu items={menuItems} preferredPlacement={"down"} subject={group.folderName} />
      </div>
      ...
      <div className="flex items-center gap-3 px-3.5 py-2.5">
        ...
        {confirmingRemove ? (
          ...
          <div className="flex flex-none items-center gap-1.5">
            ...
            <SkillRowMenu items={menuItems} preferredPlacement={"down"} subject={skill.displayName} />
          </div>
        )}
      </div>
