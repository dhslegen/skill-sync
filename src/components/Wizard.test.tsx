...
const index = (curated: string[]): StoreIndexView => ({
  ...
  curated,
  skills: [
    { name: "周报生成", dirSlug: "weekly-report", description: "周报", path: "", hasScripts: false, fileCount: 1, contentHash: "sha256:a", tags: [], author: null, updatedAt: { kind: "unknown" } },
    { name: "合同审查助手", dirSlug: "contract-review", description: "合同", path: "", hasScripts: false, fileCount: 1, contentHash: "sha256:b", tags: [], author: null, updatedAt: { kind: "unknown" } },
  ],
});
